...
This analysis combines data collected in three different yearsm 2015, 2016 and 2017.
...
Raw data for this project was prject was provided in 3 files, one for each country.
...
The table clean_candy_data_csv contains all candy types and ratings. The data columns are id, year, candy_type and rating.

The table clean_rater_data.csv contains demographic information for each rater who completed the survey. The data columns are 
 ...
 *gender - categories are male, female, other and prefer not to say.
 *tot - 'going out' intent indicates if participant was intending on going out trick or treating
 *country - categories are usa, canada, uk and other. 
...
The following candy types were identified as equivalent and matched across the three different year datasets.
